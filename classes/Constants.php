...
class Constants
{
    public static $firstnameCharacters = "First name length must be 2 to 50 characters long";
    public static $lastnameCharacters = "Last name length must be 2 to 50 characters long";
    public static $usernameCharacters = "Username length must be 2 to 50 characters long";
    public static $usernameTaken = "Username already taken";
    public static $emailDontMatch = "Email inputs don't match";
    ...
    public static $invalidCode = "Your code is invalid";
}
